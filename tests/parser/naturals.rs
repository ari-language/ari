...
fn bottom() {
    assert_eq!(
        ...
        (
            Some(Scope::try_from_exprs([Expr::natural([], 0..1, 0u8)]).unwrap()),
            vec![]
        )
    );
}
...
fn unit() {
    assert_eq!(
        ...
        (
            Some(Scope::try_from_exprs([Expr::natural([], 0..1, 1u8)]).unwrap()),
            vec![]
        )
    );
}
...
fn decimal() {
    assert_eq!(
        ...
        (
            Some(Scope::try_from_exprs([Expr::natural([], 0..3, 256u16)]).unwrap()),
            vec![],
        )
    );
}
...
fn binary() {
    assert_eq!(
        ...
        (
            Some(Scope::try_from_exprs([Expr::natural([], 0..11, 256u16)]).unwrap()),
            vec![],
        )
    );
}
...
fn octal() {
    assert_eq!(
        ...
        (
            Some(Scope::try_from_exprs([Expr::natural([], 0..5, 256u16)]).unwrap()),
            vec![],
        )
    );
}
